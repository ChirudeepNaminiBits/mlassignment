...
st.info("Please upload the 'test_data.csv' generated by your training script.")
            ...
            if selected_model_name in ["Logistic Regression", "KNN"]:
                if scaler:
                    try:
                        ...
                        st.error("columns mismatch! Ensure the uploaded CSV has the same columns as the training data.")
                        st.stop()
                else:
